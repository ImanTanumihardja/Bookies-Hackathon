...
contract TournamentBookie is ITournamentBookie, KeeperCompatibleInterface 
{
    ...
    TournamentBookieInfo private bookieInfo_;

    constructor(TournamentBookieInfo memory bookieInfo)
    {
    ...
    function getBookieInfo() external view returns(TournamentBookieInfo memory) 
    {
        return bookieInfo_;
    }
